...
This repo is the real product build: one Next.js 15 monorepo with three role-gated sections (`/app` for diners, `/dashboard` for merchants, `/admin` for ops), shared auth, shared database.
...
- Consumer: `https://mealmate-jet.vercel.app`
- Merchant: `https://mealmate-merchant.vercel.app`
- Admin: `https://mealmate-admin.vercel.app`
